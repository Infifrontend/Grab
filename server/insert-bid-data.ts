...
const bidData = [
    {
        ...
        "valid_until": "2025-08-05T13:00:00.000Z",
        ...
        "created_at": "2025-07-24T07:39:29.133Z",
        "updated_at": "2025-07-24T07:40:59.384Z"
    },
    {
        "id": 26,
        "user_id": 1,
        ...
        "passenger_count": 5,
        "bid_status": "completed",
        "valid_until": "2025-08-10T13:00:00.000Z",
        ...
        "created_at": "2025-07-24T07:46:16.614Z",
        "updated_at": "2025-07-24T08:27:45.382Z"
    },
    {
        "id": 27,
        "user_id": 1,
        ...
        "created_at": "2025-07-24T08:26:44.981Z",
        "updated_at": "2025-07-24T08:44:24.445Z"
    },
    {
        "id": 28,
        "user_id": 1,
        ...
        "passenger_count": 2,
        "bid_status": "completed",
        "valid_until": "2025-08-03T13:00:00.000Z",
        ...
        "created_at": "2025-07-24T08:49:47.601Z",
        "updated_at": "2025-07-24T08:51:55.519Z"
    },
    {
        "id": 29,
        "user_id": 1,
        ...
        "passenger_count": 5,
        "bid_status": "completed",
        "valid_until": "2025-07-30T13:00:00.000Z",
        ...
        "created_at": "2025-07-24T09:01:33.753Z",
        "updated_at": "2025-07-24T09:02:34.684Z"
    },
    {
        "id": 30,
        "user_id": 1,
        ...
        "created_at": "2025-07-24T09:05:57.929Z",
        "updated_at": "2025-07-24T09:05:57.929Z"
    },
    {
        "id": 31,
        "user_id": 1,
        ...
        "created_at": "2025-07-24T09:07:52.073Z",
        "updated_at": "2025-07-24T09:07:52.073Z"
    },
    {
        "id": 32,
        "user_id": 1,
        ...
        "created_at": "2025-07-24T09:08:46.996Z",
        "updated_at": "2025-07-24T09:08:46.996Z"
    }
];
...
export async function insertBidData() {
    ...
    try {
        for (const bid of bidData) {
            ...
            console.log(`Inserting bid ${bidRecord.id}...`);

            // Check if bid already exists
            const existingBid = await db.select().from(bids).where(eq(bids.id, bidRecord.id)).limit(1);
            
            if (existingBid.length > 0) {
                console.log(`Bid ${bidRecord.id} already exists, skipping...`);
                continue;
            }

            // Insert the bid record
            await db.insert(bids).values(bidRecord);
            console.log(`Successfully inserted bid ${bidRecord.id}`);
        }
        ...
        return {
            success: true,
            message: "All bid records inserted successfully",
            insertedCount: bidData.length
        };
    } catch (error) {
        console.error("Error inserting bid data:", error);
        return {
            success: false,
            message: "Failed to insert bid data",
            error: error.message
        };
    }
}
