            ...
            <Col className="cls-contrast-cont" sm={colWidth}>
                ...
                <Text className="custom-radio cls-contrast rounded">
                    ...
                    <Button
                        ...
                        value="YB"
                        onClick={handleClick}
                        data-testid="theme-yb-btn"
                    >
                        A
                    </Button>
                </Text>
            </Col>
            <Col data-testid="contrast-col" className="cls-fsize-cont" sm={colWidth}>
                Font size :
