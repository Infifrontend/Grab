...
export default function Dashboard() {
  ...
  const activeBookings =
    bookingOverview?.statusData?.confirmed ||
    flightBookings.filter((b) => b.bookingStatus === "confirmed").length;
  const totalPassengers =
    bookingOverview?.totalPassengers ||
    flightBookings.reduce((sum, b) => sum + b.passengerCount, 0);
  const upcomingTrips = flightBookings.filter(
    (b) =>
  ...
  const chartData =
    bookingOverview?.monthlyData && bookingOverview.monthlyData.length > 0
  ...
  const recentActivities = recentBookings.slice(0, 4).map((booking, index) => ({
    ...
    description: `Booking #${booking.bookingReference} ${
      booking.flight
        ? `for ${booking.flight.origin} to ${booking.flight.destination}`
        : ""
    }`,
    time: booking.createdAt
      ? getRelativeTime(new Date(booking.createdAt))
      : "Recently",
    type: "booking",
  }));
  ...
  const downloadCSV = () => {
    ...
    link.setAttribute(
      "download",
      `booking_report_${new Date().toISOString().split("T")[0]}.csv`
    );
  ...
  const downloadXLSX = () => {
    ...
    link.setAttribute(
      "download",
      `booking_report_${new Date().toISOString().split("T")[0]}.xlsx`
    );
    link.style.visibility = "hidden";
    document.body.appendChild(link);
    link.click();
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <Text className="text-gray-600">
            Manage your group travel bookings and view insights
          </Text>
        </div>
        <Space size="middle">
          <Dropdown
              ...
              <Card className="border-0 shadow-sm">
                <div className="mb-6">
                  ...
                  <Text className="text-gray-500">
                    Monthly booking trends and performance
                  </Text>
                </div>
                <div
                  style={{
            ...
            {payments.length > 0 ? (
              <div className="space-y-1">
                {payments.map((payment) => (
                  <div
                    key={payment.id}
                    className="flex justify-between items-center p-6 border-b border-gray-50 hover:bg-gray-50 transition-colors"
                  >
      ...
      {activeTab === "insights" && (
        <div>
          ...
          <div className="mb-6">
            ...
            <Text className="text-gray-600">
              Data-driven insights to optimize your group travel
            </Text>
          </div>
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <Text className="text-gray-500 text-sm">
                  Personalized suggestions based on your booking patterns
                </Text>
              </div>
            </div>
            ...
            <Row gutter={[24, 24]}>
              <Col xs={24} lg={12}>
                <div className="border border-gray-100 rounded-lg p-6 hover:shadow-sm transition-shadow">
                  ...
                  <Text className="text-gray-600 text-sm mb-4 leading-relaxed">
                    Book your next group trip 60 days in advance to save an
                    estimated $450 per booking.
                  </Text>
                  <div className="flex justify-between items-center">
                    ...
                    <Button
                      type="link"
                      className="text-[var(--infiniti-primary)] p-0 text-sm font-medium"
                    >
                      Learn More →
                    </Button>
                  </div>
              ...
              <Col xs={24} lg={12}>
                <div className="border border-gray-100 rounded-lg p-6 hover:shadow-sm transition-shadow">
                  ...
                  <Text className="text-gray-600 text-sm mb-4 leading-relaxed">
                    Explore our group packages that offer up to 15% savings for
