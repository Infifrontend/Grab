...
export default function BookingDetails() {
  ...
  const totalAmount =
    comprehensiveData?.pricingSummary?.totalAmount || booking.totalAmount;
              ...
              <Row gutter={[24, 16]}>
                <Col xs={24} sm={6}>
                  <div>
                    ...
                    <Text className="text-gray-600 text-sm block">
                      Duration:{" "}
                      {comprehensiveData?.flightDetails?.outbound?.duration ||
                        flightData?.duration ||
                        "7h 45m"}
                    </Text>
                  </div>
                ...
                <Col xs={24} sm={6}>
                  <div>
                    ...
                    <Text className="text-gray-900 font-medium">
                      {comprehensiveData?.flightDetails?.outbound
                        ?.flightNumber ||
                    ...
                    <Text className="text-gray-600 text-sm block">
                      Aircraft:{" "}
                      {comprehensiveData?.flightDetails?.outbound?.aircraft ||
                        flightData?.aircraft ||
                        "Boeing 777-300ER"}
                    </Text>
                  </div>
                  ...
                  <Row gutter={[24, 16]}>
                      ...
                      <div>
                        ...
                        <Text className="text-gray-900 font-medium">
                          ...
                          {comprehensiveData?.flightDetails?.return?.airline ||
                            ...
                            comprehensiveData?.selectedFlights?.return
                              ?.airline ||
                            flightData?.airline ||
                            "British Airways"}
                        </Text>
                        <Text className="text-gray-600 text-sm block">
                          Duration:{" "}
                          {comprehensiveData?.flightDetails?.return?.duration ||
                    ...
                    <Col xs={24} sm={6}>
                      <div>
                        ...
                        <Text className="text-gray-900 font-medium">
                          {comprehensiveData?.flightDetails?.return
                            ?.flightNumber ||
                        ...
                        <Text className="text-gray-600 text-sm block">
                          Aircraft:{" "}
                          {comprehensiveData?.flightDetails?.return?.aircraft ||
                        ...
                        <Text className="text-gray-900 font-medium">
                          {comprehensiveData?.flightDetails?.return
                            ...
                            : flightData?.return?.departureTime
                              ? dayjs(flightData.return.departureTime).format(
                                  "DD MMM YYYY h:mm A",
                                )
                              : bookingData?.returnDate
                        ...
                        <Text className="text-gray-900 font-medium">
                          {comprehensiveData?.flightDetails?.return?.arrivalTime
                            ...
                            : flightData?.return?.arrivalTime
                              ? dayjs(flightData.return.arrivalTime).format(
                                  "DD MMM YYYY h:mm A",
                                )
                              : bookingData?.returnDate
                                ? dayjs(bookingData.returnDate).format(
          ...
          <Card>
            ...
            <div className="space-y-4">
              {passengers && passengers.length > 0
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <Text className="text-gray-600 text-sm">
                            {passenger.nationality} • DOB:{" "}
                            {dayjs(passenger.dateOfBirth).format("DD MMM YYYY")}
                          </Text>
                ...
                : Array.from(
                    { length: booking.passengerCount || 1 },
                    (_, index) => (
                      <div
                        key={index}
                        className="border border-gray-200 rounded-lg p-4"
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <Text className="text-gray-600 text-sm">
                      {comprehensiveData?.paymentInfo?.paymentMethod ||
                        "To be determined"}
                    </Text>
                  </div>
                  <Text
                    className={`text-xl font-semibold ${booking.bookingStatus === "confirmed" ? "text-green-600" : "text-orange-600"}`}
                  >
