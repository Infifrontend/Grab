                    ...
                    {offersModalTab === "template" && (
                      <div className="space-y-6">
                        <div>
                          ...
                          <Text className="text-gray-600 block mb-6">
                            Choose a template that defines the offer structure
                            and target market
                          </Text>
                    ...
                    {offersModalTab === "dynamicPricing" && (
                      <div className="space-y-6">
                        <div>
                          ...
                          <Text className="text-gray-600 block mb-6">
                            Configure real-time fare integration and pricing
                            multipliers
                          </Text>
                          ...
                          <div className="mb-8">
                            ...
                            <Text className="text-gray-600 text-sm mb-4">
                              Configure applicable discounts and promotional
                            ...
                            <div className="mb-4">
                              ...
                              <Form.Item name="promoCodes">
                                <Checkbox.Group>
                                  <Row gutter={[16, 8]}>
                                    <Col span={6}>
                                      <Checkbox value="BUSINESS25">
                                        BUSINESS25
                                      </Checkbox>
                                    </Col>
                                    <Col span={6}>
                                      <Checkbox value="PREMIUM15">
                                        PREMIUM15
                                      </Checkbox>
                                    </Col>
                                    <Col span={6}>
                                    ...
                                    <Col span={6}>
                                      <Checkbox value="WEEKEND15">
                                        WEEKEND15
                                      </Checkbox>
                                    </Col>
                                    <Col span={6}>
                                      <Checkbox value="FIRST10">
                                        FIRST10
                                      </Checkbox>
                                    </Col>
                                    <Col span={6}>
                                    ...
                                    <Col span={6}>
                                      <Checkbox value="SUMMER2024">
                                        SUMMER2024
                                      </Checkbox>
                                    </Col>
                                    <Col span={6}>
                                      <Checkbox value="LOYALTY25">
                                        LOYALTY25
                                      </Checkbox>
                                    </Col>
                                  </Row>
