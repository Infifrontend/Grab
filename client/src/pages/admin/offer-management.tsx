  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Modal
        ...
        footer={null}
        width={
          activeTab === "policies" || activeTab === "ancillaries" || activeTab === "offers" ? 1000 : 600
        }
            ...
            <>
              ...
              <div style={{ minHeight: "400px" }}>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <Row gutter={16} className="mb-4">
                        <Col span={12}>
                          <Form.Item
                            label={<span className="font-medium">Offer Name <span className="text-red-500">*</span></span>}
                            name="offerName"
                        ...
                        <Col span={12}>
                          <Form.Item
                            label={<span className="font-medium">Offer Code <span className="text-red-500">*</span></span>}
                            name="offerCode"
                      ...
                      <Row gutter={16} className="mb-4">
                        ...
                        <Col span={8}>
                          <Form.Item
                            label={<span className="font-medium">Base Price ($)</span>}
                            name="basePrice"
                            initialValue={0}
                          >
                            <InputNumber
                  ...
                  <div className="space-y-6">
                    <div>
                      <div className="flex items-center mb-4">
                        ...
                        <Title level={4} className="!mb-2">Offer Templates</Title>
                      </div>
                      <Text className="text-gray-600 block mb-6">
                        Choose a template that defines the offer structure and target market
                      </Text>
                      ...
                      <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                        <Text className="font-medium text-blue-900 block mb-2">Selected Template: Value</Text>
                        <Text className="text-blue-700 text-sm">
                          Perfect for travelers who want a good balance of features and price.
                        </Text>
                      </div>
                    </div>
                  </div>
                ...
                {offersModalTab === "ancillaries" && (
                  <div className="space-y-6">
                    <div>
                      <Title level={4} className="!mb-4">Ancillaries</Title>
                      <Text className="text-gray-600 block mb-6">
                      ...
                      <Form.Item name="ancillaryServices">
                        <Checkbox.Group className="w-full">
                          <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-3">
                              <Text className="font-medium text-gray-900">Seating</Text>
                              <div className="space-y-2">
                                <div>
                                  <Checkbox value="extra-legroom">Extra Legroom</Checkbox>
                                </div>
                                <div>
                                  <Checkbox value="window-seat">Window Seat Selection</Checkbox>
                                </div>
                                <div>
                                  <Checkbox value="aisle-seat">Aisle Seat Selection</Checkbox>
                                </div>
                              </div>
                            </div>
                            
                            <div className="space-y-3">
                              <Text className="font-medium text-gray-900">Food & Beverage</Text>
                              <div className="space-y-2">
                                <div>
                                  <Checkbox value="premium-meal">Premium Meal</Checkbox>
                                </div>
                                <div>
                                  <Checkbox value="special-meal">Special Dietary Meal</Checkbox>
                                </div>
                                <div>
                                  <Checkbox value="drinks-package">Drinks Package</Checkbox>
                                </div>
                              </div>
                            </div>

                            <div className="space-y-3">
                              <Text className="font-medium text-gray-900">Services</Text>
                              <div className="space-y-2">
                                <div>
                                  <Checkbox value="priority-boarding">Priority Boarding</Checkbox>
                                </div>
                                <div>
                                  <Checkbox value="fast-track">Fast Track Security</Checkbox>
                                </div>
                                <div>
                                  <Checkbox value="lounge-access">Lounge Access</Checkbox>
                                </div>
                              </div>
                            </div>

                            <div className="space-y-3">
                              <Text className="font-medium text-gray-900">Baggage</Text>
                              <div className="space-y-2">
                                <div>
                                  <Checkbox value="extra-baggage">Extra Baggage</Checkbox>
                                </div>
                                <div>
                                  <Checkbox value="priority-baggage">Priority Baggage</Checkbox>
                                </div>
                                <div>
                                  <Checkbox value="fragile-handling">Fragile Item Handling</Checkbox>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                {offersModalTab === "personalization" && (
                  <div className="space-y-6">
                    <div>
                      <Title level={4} className="!mb-4">Personalization</Title>
                      <Text className="text-gray-600 block mb-6">
                        ...
                        <Col span={8}>
                          <div className="space-y-4">
                            ...
                            <Form.Item name="customerSegments">
                              <Checkbox.Group>
                                <div className="space-y-2">
                                  <div><Checkbox value="business">Business Travelers</Checkbox></div>
                                  <div><Checkbox value="leisure">Leisure Travelers</Checkbox></div>
                                  <div><Checkbox value="frequent">Frequent Flyers</Checkbox></div>
                                  <div><Checkbox value="first-time">First Time Flyers</Checkbox></div>
                                  <div><Checkbox value="family">Family Travelers</Checkbox></div>
                                  <div><Checkbox value="price-sensitive">Price Sensitive</Checkbox></div>
                                  <div><Checkbox value="premium">Premium Customers</Checkbox></div>
                                </div>
                              </Checkbox.Group>
                            </Form.Item>
                          </div>
                        ...
                        <Col span={8}>
                          <div className="space-y-4">
                            ...
                            <Form.Item name="behaviorTriggers">
                              <Checkbox.Group>
                                <div className="space-y-2">
                                  <div><Checkbox value="previous-premium">Previous premium purchases</Checkbox></div>
                                  <div><Checkbox value="route-frequency">Route frequency > 5</Checkbox></div>
                                  <div><Checkbox value="price-comparison">Price comparison activity</Checkbox></div>
                                  <div><Checkbox value="previous-bookings">Previous bookings</Checkbox></div>
                                  <div><Checkbox value="first-booking">First booking</Checkbox></div>
                                  <div><Checkbox value="multiple-passenger">Multiple passenger bookings</Checkbox></div>
                                </div>
                              </Checkbox.Group>
                            </Form.Item>
                          </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      <div className="flex items-center mb-4">
                        ...
                        <Title level={4} className="!mb-2">Dynamic Pricing Configuration</Title>
                      </div>
                      <Text className="text-gray-600 block mb-6">
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg mb-6">
                        <Form.Item name="enableDynamicPricing" valuePropName="checked" className="!mb-0">
                          <div className="flex items-center justify-between">
                      ...
                      <div className="mb-8">
                        <div className="flex items-center mb-4">
                          ...
                          <Text className="font-medium">Discount & Promo Evaluation</Text>
                        </div>
                        <Text className="text-gray-600 text-sm mb-4">
                          Configure applicable discounts and promotional codes for this offer
                        </Text>

                        <div className="mb-4">
                          <Text className="font-medium text-sm mb-3">Applicable Promo Codes</Text>
                        ...
                        <Row gutter={16} className="mb-4">
                          ...
                          <Col span={8}>
                            <div className="mt-6">
                              <Form.Item name="allowDiscountStacking" valuePropName="checked" className="!mb-0">
                ...
                {offersModalTab === "outputChannels" && (
                  <div className="space-y-6">
                    <div>
                      <Title level={4} className="!mb-4">Output Channels</Title>
                      <Text className="text-gray-600 block mb-6">
                      ...
                      <Row gutter={24}>
                        <Col span={12}>
                          <div className="bg-white border rounded-lg p-6 mb-6">
                            <div className="flex items-center mb-4">
                              ...
                              <Text className="font-medium text-lg">Website Integration</Text>
                            </div>
                            <Form.Item name="enableWebsite" valuePropName="checked" className="mb-4">
                              <div className="flex items-center">
                                <Switch className="mr-3" />
                            ...
                            <div>
                              <Text className="text-sm text-gray-600 mb-2">Display Mode</Text>
                        ...
                        <Col span={12}>
                          <div className="bg-white border rounded-lg p-6 mb-6">
                            <div className="flex items-center mb-4">
                              <span className="text-2xl mr-3">📱</span>
                              <Text className="font-medium text-lg">Mobile Application</Text>
                            </div>
                            <Form.Item name="enableMobile" valuePropName="checked" className="mb-4">
                              <div className="flex items-center">
                                <Switch className="mr-3" />
                                <Text>Enable Mobile Distribution</Text>
                              </div>
                            </Form.Item>
                            <Form.Item name="mobileOptimized" valuePropName="checked" className="!mb-0">
                              <div className="flex items-center">
                                <Switch className="mr-3" />
                        ...
                        <Col span={12}>
                          <div className="bg-white border rounded-lg p-6">
                            <div className="flex items-center mb-4">
                              <span className="text-2xl mr-3">⚡</span>
                              <Text className="font-medium text-lg">NDC Integration</Text>
                            </div>
                            <Form.Item name="enableNDC" valuePropName="checked" className="!mb-0">
                              <div className="flex items-center">
                                <Switch className="mr-3" />
                        ...
                        <Col span={12}>
                          <div className="bg-white border rounded-lg p-6">
                            <div className="flex items-center mb-4">
                              <span className="text-2xl mr-3">📊</span>
                              <Text className="font-medium text-lg">API Integration</Text>
                            </div>
                            <Form.Item name="enableAPI" valuePropName="checked" className="!mb-0">
                              <div className="flex items-center">
                                <Switch className="mr-3" />
