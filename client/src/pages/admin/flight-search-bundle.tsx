...
export default function FlightSearchBundle() {
  ...
  const handleContinue = () => {
    ...
    navigate("/admin/add-services-bundles");
  };
        ...
        <Col span={19}>
          ...
          <div className="flex items-center gap-3">
            <div className="text-center">
              ...
              <Text className="text-xs block text-gray-500 pl-1">{flight.origin}</Text>
            </div>
            ...
            <div className="text-center">
              ...
              <Text className="block text-xs text-gray-500 pl-1">
                {flight.destination}
              </Text>
            </div>
            <div className="">
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        {/* Sidebar */}
        <AdminSidebar activeMenu="Booking Managment" />
