    ...
    <>
      ...
      <Card className="routes-card">
        <div className="mb-6">
          ...
          <Text className="text-gray-500">
            Revenue and booking performance by route
          </Text>
        </div>
        ...
        <Col xs={24}>
          <Card className="chart-card">
            <div className="mb-6">
              ...
              <Text className="text-gray-500">
                Daily booking patterns and seasonal trends
              </Text>
            </div>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <Col xs={24}>
          <Card className="chart-card">
            <div className="mb-6">
              ...
              <Text className="text-gray-500">
                Best converting offers by revenue and booking volume
              </Text>
            </div>
            <div className="space-y-6">
              {[
                {
                  name: "Premium Meal Bundle",
      ...
      <Row gutter={[24, 24]} className="mb-8">
              ...
              <div className="p-4 bg-yellow-50 rounded-xl border border-yellow-200">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <Text className="text-gray-600 text-sm">
                      Increase pricing on LAX-JFK route by 15% during Q4 for
                      optimal revenue
                    </Text>
                  </div>
                </div>
              ...
              <div className="p-4 bg-blue-50 rounded-xl border border-blue-200">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <Text className="text-gray-600 text-sm">
                      Launch premium meal bundles on weekend flights for 23%
                      higher conversion
                    </Text>
                  </div>
                </div>
              ...
              <div className="p-4 bg-green-50 rounded-xl border border-green-200">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <Text className="text-gray-600 text-sm">
                      Expand group bookings marketing to corporate segment for
                      31% revenue boost
                    </Text>
                  </div>
                </div>
        ...
        <Col xs={24} lg={12}>
          <Card className="insights-card">
            ...
            <Text className="text-gray-600 mb-6">
              Important trends and anomalies
            </Text>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-red-50 rounded-xl border border-red-200">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <Text className="font-semibold text-gray-900 block mb-1">
                      Booking Decline Alert
                    </Text>
                    <Text className="text-gray-600 text-sm">
                      15% drop in MIA-SFO bookings detected this week
                    </Text>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded-xl border border-green-200">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <Text className="text-gray-600 text-sm">
                      Premium meal offers showing 34% above-expected performance
                    </Text>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 bg-blue-50 rounded-xl border border-blue-200">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <Text className="text-gray-600 text-sm">
                      Business travel segment recovery accelerating faster than
                      predicted
                    </Text>
                  </div>
                </div>
        ...
        <Col xs={24} lg={12}>
          <Card className="chart-card">
            <div className="mb-6">
              ...
              <Text className="text-gray-500">
                Predicted booking volumes for next 4 quarters
              </Text>
            </div>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <Col xs={24}>
          <Card className="insights-card">
            <div className="mb-6">
              ...
              <Text className="text-gray-500">
                AI-powered demand forecasting and risk assessment
              </Text>
            </div>
            ...
            <div className="space-y-4">
              {[
                ...
                {
                  route: "ORD → LAX",
                  seasonality: "Medium Seasonality",
                  demand: 76,
                  growth: 18.2,
                  risk: "Low",
                },
            ...
            <Row gutter={[32, 24]}>
              ...
              <Col xs={24} md={8}>
                <div className="text-center p-6 bg-purple-50 rounded-xl border border-purple-200">
                  ...
                  <Text className="text-3xl font-bold text-purple-600 block">
                    12
                  </Text>
                  <Text className="text-gray-600 font-medium">
