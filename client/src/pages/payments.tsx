  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        <Row gutter={[24, 24]} className="mb-8">
          <Col xs={24} sm={12} lg={6}>
            <Card className="text-center">
              ...
              <Title level={3} className="!mb-1 text-gray-900">
                $
                {paymentStats.totalPayments.toLocaleString("en-US", {
          ...
          <Col xs={24} sm={12} lg={6}>
            <Card className="text-center">
              ...
              <Title level={3} className="!mb-1 text-gray-900">
                $
                {paymentStats.pendingPayments.toLocaleString("en-US", {
                  minimumFractionDigits: 2,
                })}
              </Title>
          ...
          <Col xs={24} sm={12} lg={6}>
            <Card className="text-center">
              ...
              <Title level={3} className="!mb-1 text-gray-900">
                $
                {paymentStats.upcomingPayments.toLocaleString("en-US", {
                  minimumFractionDigits: 2,
                })}
              </Title>
              <Text className="text-gray-500 text-sm">
          ...
          <Col xs={24} sm={12} lg={6}>
            <Card className="text-center">
              ...
              <Title level={3} className="!mb-1 text-gray-900">
                $
                {paymentStats.refundsProcessed.toLocaleString("en-US", {
                  minimumFractionDigits: 2,
                })}
              </Title>
              <Text className="text-gray-500 text-sm">
                {paymentData.filter((p) => p.type === "Refund").length} refunds
                this month
              </Text>
            </Card>
          </Col>
        ...
        <Card>
          <div className="mb-6">
            ...
            <Text className="text-gray-600">
              View and manage all payments for your group bookings.
            </Text>
          </div>
      ...
      {activeTab === "payment-schedule" && (
        <Card>
          <div className="mb-6">
            ...
            <Text className="text-gray-600">
              Manage scheduled payments for your bookings.
            </Text>
          </div>
      ...
      >
        <div className="mb-4">
          <Text className="text-gray-600">
            Enter the payment details below to complete your payment for the
            selected booking.
          </Text>
        </div>
        ...
        >
            ...
            <Col span={12}>
              ...
              >
                <Select placeholder="Select booking">
                  <Select.Option value="GR-2024-1001">
                    GR-2024-1001
                  </Select.Option>
                  <Select.Option value="GR-2024-1002">
                    GR-2024-1002
                  </Select.Option>
                  <Select.Option value="GR-2024-1003">
                    GR-2024-1003
                  </Select.Option>
                </Select>
              </Form.Item>
          ...
          <Form.Item label="Full Payment: ₹4,500.00 (remaining balance)">
            <div className="text-blue-600 font-medium">
              Full Payment: $4,500.00 (remaining balance)
            </div>
          </Form.Item>
          ...
          >
            <Radio.Group className="w-full">
              <div className="space-y-3">
                <Radio
                  value="creditCard"
                  className="flex items-center p-3 border border-gray-200 rounded-lg hover:border-blue-500"
                >
                  <div className="flex items-center gap-3">
          ...
          <Form.Item
            ...
            rules={[
              { required: true, message: "Please enter card number" },
              {
                ...
                message:
                  "Please enter valid card number format (1234 5678 9012 3456)",
              },
            ]}
          >
