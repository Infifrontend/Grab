          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <Text className="text-gray-600 text-sm">GROUP RETAIL</Text>
                  <br />
          ...
          <div className="mb-8">
            ...
            <div className="flex space-x-8 border-b border-gray-200">
              <div className="pb-3 border-b-2 border-blue-600">
                <Text className="text-blue-600 font-medium">📊 Overview</Text>
              </div>
              <div className="pb-3">
                <Text className="text-gray-500">📅 Bookings Analytics</Text>
              </div>
              <div className="pb-3">
                <Text className="text-gray-500">💰 Offers Analytics</Text>
              </div>
              <div className="pb-3">
                <Text className="text-gray-500">📈 Insights & Forecasts</Text>
              </div>
            </div>
          </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-2 mt-1">
                      ...
                      <div className="flex items-center space-x-1 text-green-600">
                        <RiseOutlined className="text-xs" />
                        <Text className="text-green-600 text-sm">+18.5%</Text>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-2 mt-1">
                      ...
                      <div className="flex items-center space-x-1 text-purple-600">
                        <Text className="text-purple-600 text-sm">34.5% conversion</Text>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-2 mt-1">
                      ...
                      <div className="flex items-center space-x-1 text-yellow-600">
                        <Text className="text-yellow-600 text-sm">across all routes</Text>
                      </div>
                    </div>
                  </div>
              ...
              {topRoutesData.map((route, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <Text className="font-medium text-gray-900">{route.route}</Text>
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <Text className={`text-sm ${route.growth > 0 ? 'text-green-600' : 'text-red-600'}`}>
